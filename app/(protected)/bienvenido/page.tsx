    ...
    <LayoutDefault>
      ...
      <div className="max-w-[80%] mx-auto">
        <p className="pb-4 mb-4">
          Tenemos el agrado de dirigirnos a usted a fin de informarle que Campus
          Norte, UNC, a través de su Dirección de Prospectiva Institucional,
          junto al INTA Córdoba han puesto en marcha{" "}
          <b>
        ...
        <p className="pb-4 mb-4">
          El estudio se focaliza en construir conocimiento prospectivo sobre las
          demandas de competencias profesionales del sector de la
          agrobioindustria alimentaria, priorizado por Campus Norte de la
          Universidad Nacional de Córdoba en la pluri-temporalidad de 1, 3, 5, 7
          y 10 años, a través del análisis tecnológico e impactos ocupacionales
          de acuerdo con el modelo prospectivo del SENAI- Brasil.
        </p>
        <p className="pb-4 mb-4">
        ...
        <p className="pb-4 mb-4">
          ...
          deberá ser completada antes del 17 de mayo de 2024 (fecha límite) para
          ser incorporada en el procesamiento general y, por ende, en los
        ...
        <p className="pb-4 mb-4">
          Asimismo, conforme a las previsiones de la Ley 17.622 se garantiza el
          secreto de informante, estableciendo que toda la información provista
          será considera estrictamente confidencial. Los datos serán ingresados
          en una base sin realizar ninguna atribución personal, pero los
          expertos que respondan el cuestionario serán listados como
        ...
        <p className="pb-4 mb-4">
          ...
          finales una vez que el estudio sea publicado. Asimismo, siéntase libre
          de compartir está invitación con otros expertos que pudieran estar
          interesados.
        </p>
        <p className="pb-4 mb-4">
